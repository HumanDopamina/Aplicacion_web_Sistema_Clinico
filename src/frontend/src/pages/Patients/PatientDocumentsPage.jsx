...
import { getPatient, listDocumentCategories, listPatientConsultationOptions, listPatientDocuments } from '../../services/patientService'
...
export default function PatientDocumentsPage() {
  ...
  useEffect(() => {
    ...
    return () => { active = false }
  }, [accessToken, category, consultationId, deferredSearch, page, patientId])

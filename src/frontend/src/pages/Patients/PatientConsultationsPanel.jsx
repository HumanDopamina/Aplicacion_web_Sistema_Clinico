...
export default function PatientConsultationsPanel({ accessToken, patientId }) {
  ...
  return <section aria-labelledby="patient-consultations-title" className="mt-6 overflow-hidden rounded-2xl border border-slate-200 bg-white shadow-sm">
    <header className="border-b border-slate-200 p-5 sm:p-6">
      <p className="text-[10px] font-bold uppercase tracking-[0.16em] text-cyan-700">Historial médico</p>
      ...
      <p className="mt-1 text-sm text-slate-500">Consulta el seguimiento y la evolución clínica.</p>
    </header>
